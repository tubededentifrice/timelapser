...
public class PictureTaker2 extends APictureTaker {
    ...
    private final static Semaphore cameraOpenCloseLock = new Semaphore(1);
    ...
    public void takePicture(final PictureTakerParameters pictureTakerParameters) {
        if (cameraManager!=null) {
            ...
            try {
                // Continue even without the lock, since we need to recover any situation
                cameraOpenCloseLock.tryAcquire(10000, TimeUnit.MILLISECONDS);
                ...
                Log.e("PictureTaker2", "Interrupted", e);
            }
        }
    }
