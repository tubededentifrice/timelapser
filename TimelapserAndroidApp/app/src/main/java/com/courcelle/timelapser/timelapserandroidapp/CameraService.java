...
/**
 * Created by tubed on 03/12/2016.
 */
...
// a variable to control the camera
    ...
    private Camera openFrontFacingCameraGingerbread() {
        if (debug) {
            Toast.makeText(this, "openFrontFacingCameraGingerbread", Toast.LENGTH_SHORT).show();
        }
    ...
    private void setBesttPictureResolution() {
        if (debug) {
            Toast.makeText(this, "setBesttPictureResolution", Toast.LENGTH_SHORT).show();
        }
    ...
    private Camera.Size getBiggesttPictureSize(Camera.Parameters parameters) {
        if (debug) {
            Toast.makeText(this, "getBiggesttPictureSize", Toast.LENGTH_SHORT).show();
        }
    ...
    private boolean checkCameraHardware(Context context) {
        if (debug) {
            Toast.makeText(this, "checkCameraHardware", Toast.LENGTH_SHORT).show();
        }
    ...
    private boolean checkFrontCamera(Context context) {
        if (debug) {
            Toast.makeText(this, "checkFrontCamera", Toast.LENGTH_SHORT).show();
        }
    ...
    private synchronized void takeImage(Intent intent) {
        if (debug) {
            Toast.makeText(this, "takeImage", Toast.LENGTH_SHORT).show();
        }
